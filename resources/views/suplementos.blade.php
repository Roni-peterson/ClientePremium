...
<head>
    <meta charset="UTF-8" />
    <title>Cliente Premium - Suplementos</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <script>
        // Verifica largura da tela e redireciona para o layout apropriado
        window.onload = function() {
            var mobileRoute = "{{ route('suplementos.mobile') }}"; // Gera a URL para a versão mobile
            var desktopRoute = "{{ route('suplementos.desktop') }}"; // Gera a URL para a versão desktop
