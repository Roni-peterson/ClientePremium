...
<head>
    ...
    <title>Cliente Premium - DLI (Mobile)</title>
    ...
    <link rel="preload" as="image" href="{{ asset('images/img_dli_secao1.png') }}">
    <link rel="preload" as="image" href="{{ asset('images/img_dli_secao2.png') }}">
    <link rel="preload" as="image" href="{{ asset('images/logo_dino_branco.png') }}">
</head>
...
<body class="font-sans">
    ...
    <div class="w-full h-screen bg-no-repeat bg-cover bg-center"
        style="background-image: url('{{ asset('images/img_dli_secao1_completa.png') }}');">
    ...
    <div id="formulario"
        ...
        style="background-image: url('{{ asset('images/img_dli_secao2.png') }}');">
